...
import { getAffiliateSummary, getAvailableAffiliatePayoutCents, AFFILIATE_MIN_PAYOUT_CENTS, getAffiliateTeamTree } from "@/lib/affiliate";
...
export default async function AffiliatePage() {
  ...
  const [summary, availableToRequestCents, referralsRes, teamTree, earningsRes, payoutsRes] = await Promise.all([
    ...
    getAffiliateTeamTree(admin, user.id, profile.display_name ?? null),
